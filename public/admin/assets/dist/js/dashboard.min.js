$(document).ready(function () {
    "use strict";
    $(".se-pre-con").fadeOut("slow"), $("body").append('<div id="toTop" class="btn back-top"><span class="ti-arrow-up"><i class="fa fa-arrow-up"></i></span></div>'), $(window).on("scroll", function () {
        ...
        type: "bar", barColor: "#37a000", height: "35", barWidth: "3", barSpacing: 2
    }
    ), $(".sparkline2").sparkline([-8, 2, 4, 3, 5, 4, 3, 5, 5, 6, 3, 9, 7, 3, 5, 6, 9, 5, 6, 7, 2, 3, 9, 6, 6, 7, 8, 10, 15, 16, 17, 15], {
        type: "line", height: "35", width: "100%", lineColor: "#37a000", fillColor: "#fff"
    }
    ), $(".sparkline3").sparkline([2, 5, 3, 7, 5, 10, 3, 6, 5, 7], {
        type: "line", height: "35", width: "100%", lineColor: "#37a000", fillColor: "#fff"
    }
    ), $(".sparkline4").sparkline([10, 34, 13, 33, 35, 24, 32, 24, 52, 35], {
        type: "line", height: "35", width: "100%", lineColor: "#37a000", fillColor: "rgba(55, 160, 0, 0.7)"
    }
    ),
