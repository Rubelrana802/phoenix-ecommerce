        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
            	...
            	<div class="panel-body">
            		<form action="{{ route('customer.payment.submit') }}" enctype="multipart/form-data" method="post" accept-charset="utf-8" id="customer_payment">
            			@csrf
                        <div class="row">
                          	<div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="date" id="dtpDate" class="form-control datepicker" value="{{ date('Y-m-d') }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6" id="name">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="customer_id" class=" form-control" id="cname" tabindex="1" required="">
                            ...
                            <div class="col-sm-6" id="payment_from_1">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea  name="detaits" id="txtRemarks" class="form-control"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
		                    ...
		                    <div class="col-sm-8">
		                        <div class="form-group row">
		                        	...
		                        	<div class="col-sm-4">
		                             	<input type="text" name="balance" id="previous" class="form-control text-right" value="100" readonly="">
		                        	</div>
		                    	</div> 
			                    ...
			                    <div class="form-group row">
			                        ...
			                        <div class="col-sm-4">
			                            <input type="text" name="grand_total_price" value="" class="form-control total_price text-right"  id="paid_amount" onkeyup="calculation(1)" required>
			                        </div>
			                    </div> 
