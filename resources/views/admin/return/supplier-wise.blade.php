                        ...
                        <div class="panel-body">
                            <div class="row" style="border-bottom:2px #333 solid;">
                                ...
                                <div class="col-sm-4 text-left" style="display: inline-block;margin-left: 5px;">
                                    ...
                                    <div> Invoice No: <span style="font-size: 18px;">{{ $customers->return_no }}</span></span></div>
                                    <div class="m-b-15">Billing Date: {{ date("d-M-Y", strtotime($customers->return_date ))}}</div>

                                    <span class="label label-danger-outline m-r-15">Billing To</span>

                                    <address style="margin-top:10px;width: 200px">  
                                        <strong style="font-size: 20px; ">{{ $customers->supplier_name }} </strong><br>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right">{{ $invoice->return_qty }}</td>
                                            <td></td>
                                            <td align="right">{{ $websetting->currency }} {{ $invoice->price }}</td>
                                            <td align="right">{{ $websetting->currency }} {{ $invoice->total }}</td>
                                        </tr>
                                        @endforeach
                                        <tr>
                                            <td class="text-right" colspan="2" style="border: 0px"><b>Grand Total:</b></td>
                                            <!--<td style="border: 0px"></td>-->
                                            <td align="right"  style="border: 0px"><b>{{ $quantitys->return_qty}}</b></td>
                                            <td style="border: 0px"></td>
                                            <td style="border: 0px"></td>
                                            <td align="right"  style="border: 0px"><b>{{ $websetting->currency }} {{ $total_prices->total }}</b></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                ...
                                <div class="col-xs-4" style="display: inline-block;">
                                    ...
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td class="text-right grand_total">{{ $websetting->currency }} {{ $total_prices->total }}</td>
                                        </tr>
                                        <tr>
                                            <th class="text-left grand_total"> Discout:</th>
                                            <td class="text-right grand_total">{{ $websetting->currency }} {{ $total_discounts->total_dis }}</td>
                                        </tr>
                                        <tr>
                                            <th class="text-left grand_total" style="border-top: 0; border-bottom: 0;">Grand Amount : </th>
                                            <td class="text-right grand_total" style="border-top: 0; border-bottom: 0;">{{ $websetting->currency }} {{ $total_prices->total - $total_discounts->total_dis }}</td>
                                        </tr>
                                    </table>
                                    </div>
                                </div>
