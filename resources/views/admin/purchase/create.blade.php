...
@section('content')
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
                    <a href="{{ route('purchase.manage') }}" class="btn btn-primary m-b-5 m-r-2"><i class="fa fa-tasks"> </i>  Manage Purchase </a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <form action="{{ route('purchase.save') }}" class="form-vertical" id="insert_purchase" name="insert_purchase" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                        @csrf
                 ...
                 <hr style="border-top: 3px double #8c8b8b;">
                        <div class="text-center"><h2>Purchase Invoice : {{$newInvoiceID}}</h2></div>
                    ...
                    <table class="table table-bordered table-hover" id="purchaseTable">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <input type="text" id="totalDiscount" class="text-right form-control" name="total_discount" value="0.00" readonly="readonly" autocomplete="off">
                                </td>
