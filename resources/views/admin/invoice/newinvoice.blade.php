                        ...
                        <div class="table-responsive" style="margin-top: 10px">
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                ...
                                <tbody id="addinvoiceItem">
                                    <tr>
                                        <td style="width: 25%">
                                            <select name="product_id[]" class="form-control product_name_1" required="" id="product_name_1">
                                                <option value="">Select One</option>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <input type="text" id="total" class="form-control text-right" name="total" value="0.00"  readonly="" />
                                    </td>
