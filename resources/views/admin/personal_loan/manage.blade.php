        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
                    ...
                    <a href="{{ route('person.loan') }}" class="btn btn-primary m-b-5 m-r-2"><i class="fa fa-plus"> </i> Add Loan </a>
                            ...
                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ url('/person/personwise/'.$person->id ) }}">{{ $person->person_name }} </a></td>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ url('/admin/person/edit/'.$person->id ) }}" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="" data-original-title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
