        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
                    ...
                    <a href="{{ route('person.loan') }}" class="btn btn-success m-b-5 m-r-2"><i class="fa fa-plus"> </i> Add Loan </a>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                   ...
                   <form action="{{ route('person.paymentsave') }}" class="form-vertical" id="inflow_entry" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    @csrf
