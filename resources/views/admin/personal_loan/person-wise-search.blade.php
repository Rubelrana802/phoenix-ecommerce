        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
                    ...
                    <a href="{{ route('office.add') }}" class="btn btn-warning m-b-5 m-r-2"><i class="fa fa-plus"> </i> Add Person </a>

                    <a href="{{ route('office.loan') }}" class="btn btn-info m-b-5 m-r-2"><i class="fa fa-plus"> </i> Add Loan </a>
            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-body"> 
                        ...
                        <form action="{{ route('office.personwise.search') }}" class="form-vertical" id="person_ledger" method="post" accept-charset="utf-8">
                        	@csrf
